...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "About Pestr — Hospitality-Focused Pest Control" },
      { property: "og:description", content: "Pestr specializes exclusively in pest management for hotels, restaurants, and commercial kitchens across India." },
      { property: "og:url", content: "https://www.pestr.in/about" },
      { property: "og:image", content: "https://www.pestr.in/newlogo.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "About Pestr — Hospitality-Focused Pest Control" },
      { name: "twitter:description", content: "Pestr specializes exclusively in pest management for hotels, restaurants, and commercial kitchens across India." },
