...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "FAQ — Frequently Asked Questions | Pestr" },
      { property: "og:description", content: "Answers to common questions about Pestr hospitality pest control, food-safe chemistry, FSSAI compliance, and the 30-day guarantee." },
      { property: "og:url", content: "https://www.pestr.in/faq" },
      { property: "og:image", content: "https://www.pestr.in/newlogo.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FAQ — Frequently Asked Questions | Pestr" },
      { name: "twitter:description", content: "Answers to common questions about Pestr hospitality pest control, food-safe chemistry, FSSAI compliance, and the 30-day guarantee." },
