...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pricing — Pestr Hospitality Pest Control" },
      { property: "og:description", content: "Transparent pest control pricing for hotels, restaurants and kitchens. Free site inspection, no hidden fees." },
      { property: "og:url", content: "https://www.pestr.in/pricing" },
      { property: "og:image", content: "https://www.pestr.in/newlogo.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Pricing — Pestr Hospitality Pest Control" },
      { name: "twitter:description", content: "Transparent pest control pricing for hotels, restaurants and kitchens. Free site inspection, no hidden fees." },
      { name: "twitter:image", content: "https://www.pestr.in/newlogo.png" },
    ],
    links: [{ rel: "canonical", href: "https://www.pestr.in/pricing" }],
  }),
