...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Terms & Conditions — Pestr" },
      { property: "og:description", content: "Terms and conditions for using Pestr's pest control services and platform." },
      { property: "og:url", content: "https://www.pestr.in/terms" },
      { property: "og:image", content: "https://www.pestr.in/newlogo.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Terms & Conditions — Pestr" },
      { name: "twitter:description", content: "Terms and conditions for using Pestr's pest control services and platform." },
